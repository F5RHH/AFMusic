...
@app.on_message(
    filters.command(["مميزات","مميزات سيما"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس سيما ميوزك\n
⩹━★⊷⌯⌞ #SOURS SIMA ⌝⌯⊶★━⩺

★قايمه مميزات سورس سيما
